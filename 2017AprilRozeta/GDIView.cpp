...
#pragma region 2017AprilRozeta NE RADI!
//#pragma region code
//void GDIView::drawEllipse(CDC* draw,int a,int b)
//{
//	draw->Arc(CRect(0, 0, 2 * a, 2 * b),CPoint(a,0),CPoint(a,0));
//}
//
//void GDIView::drawRosete(CDC* draw, int x, int y, int size, int count)
//{
//	Translate(draw, x, y, false);
//	auto tacke = CalculateCoordinates(size,60);
//	draw->Polygon(tacke, 60);
//	for (int i = 0; i < count; i++)
//	{
//		Rotate(draw, 360 / count, false);
//		drawEllipse(draw, 50 / 3, 75);
//	}
//	tacke = CalculateCoordinates(size/5, 60);
//	draw->Polygon(tacke, 60);
//}
//void GDIView::draw()
//{
//	Translate(memDC,300, 300,false);
//	Translate(memDC,150, 300,false);
//	Rotate(memDC, 39, false);
//	//LoadIdentity(memDC);
//	
//	//drawRosete(memDC, 300, 300,150, 8);
//}
//#pragma endregion
#pragma endregion
