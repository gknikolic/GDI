...
#pragma region 2019AprMipmap
#pragma region code
void GDIView::DrawWheel(CDC* pDC, double r1, double r2, double w) {
...
void GDIView::DrawWP(CDC* pDC, double r1, double r2, double w, double L, double alpha, double d) {
    float h = tan(alpha * toRad) * L;
    float wheelAngle = (d * 360 / (2 * r1 * pi));
