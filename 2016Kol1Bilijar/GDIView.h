...
#pragma region  code
public:
    DImage* wood = new DImage();
    DImage* table = new DImage();

    void DrawStick(CDC* draw, int w);
    void DrawHole(CDC* draw, int size);
    void DrawBorder(CDC* draw, CRect rect, int w);
    void DrawTable(CDC* draw, CRect rect);
    void DrawBall(CDC* draw, int w);
    void DrawHoles(CDC* draw, CRect rect, int size);
#pragma endregion
#pragma endregion
