...
#pragma region 2020JunGrafikaShear
#pragma region code
    DImage* grafika = new DImage();
    void DrawFlag(CDC* pDC, DImage* img, float cy, float cx, float a, int n, float h, float w);
    void DrawFlags(CDC* pDC, DImage* img, float cy, float cx, int m, float a, int n, float h, float w);
#pragma endregion
#pragma endregion
