...
#pragma region code
    void DrawClock(int sati, int minuti, int sekunde);
    void DrawNum(int distance);
    void DrawHourNeedle(int angle, int distance);
    void DrawNeedles(double sati, double minuti, double sekunde);
    void DrawMinutNeedle(int angle, int distance);
    void DrawSecondNeedle(int angle, int distance);
    void SaveClock(const char* name);
    CPoint* CalculateCoordinates(int numberOfSides, float radius);
#pragma endregion
#pragma endregion
