...
#pragma region code
    COLORREF ReduceSize(CPoint p1, CPoint p2, CPoint p3, CPoint p4, CDC* drawDC);
    CDC* Resample(int x, int y, CDC* drawDC);
    void AdjutSize(CString fileName, int dstX, int dstY, CDC* pDC);
